...
<div class="wrapper">
                ...
                <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                    ...
                    <li class="nav-item has-treeview menu-open">
                        ...
                        <ul class="nav nav-treeview">
                            <li class="nav-item">
                                <a href="dashboard/./index.html" class="nav-link active">
                    ...
                    <li class="nav-item has-treeview">
                        ...
                        <ul class="nav nav-treeview">
                            ...
                            <li class="nav-item">
                                <a href="dashboard/pages/examples/e_commerce.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>E-commerce</p>
                                </a>
                            </li>
                            ...
                            <li class="nav-item">
                                <a href="dashboard/pages/examples/project_add.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Project Add</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard/pages/examples/project_edit.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Project Edit</p>
                                </a>
                            </li>
                            <li class="nav-item">
                                <a href="dashboard/pages/examples/project_detail.html" class="nav-link">
                                    <i class="far fa-circle nav-icon"></i>
                                    <p>Project Detail</p>
                                </a>
                            </li>
                    ...
                    <li class="nav-item">
                        <a href="dashboard/https://adminlte.io/docs/3.0" class="nav-link">
                            ...
                            <div class="card-header">
                                ...
                                <div class="card-tools">
                                    <ul class="pagination pagination-sm">
                                        <li class="page-item"><a href="dashboard/#" class="page-link">&laquo;</a></li>
                                        <li class="page-item"><a href="dashboard/#" class="page-link">1</a></li>
                                        <li class="page-item"><a href="dashboard/#" class="page-link">2</a></li>
                                        <li class="page-item"><a href="dashboard/#" class="page-link">3</a></li>
                                        <li class="page-item"><a href="dashboard/#" class="page-link">&raquo;</a></li>
                                    </ul>
                                </div>
                            </div>
                            <!-- /.card-header -->
                                ...
                                <div class="card-tools">
                                    ...
                                    <div class="btn-group">
                                        ...
                                        <div class="dropdown-menu float-right" role="menu">
                                            <a href="dashboard/#" class="dropdown-item">Add new event</a>
                                            <a href="dashboard/#" class="dropdown-item">Clear events</a>
                                            <div class="dropdown-divider"></div>
                                            <a href="dashboard/#" class="dropdown-item">View calendar</a>
                                        </div>
                                    </div>
    ...
    <footer class="main-footer">
        <strong>Copyright &copy; 2014-2019 <a href="dashboard/http://adminlte.io">AdminLTE.io</a>.</strong>
        All rights reserved.
